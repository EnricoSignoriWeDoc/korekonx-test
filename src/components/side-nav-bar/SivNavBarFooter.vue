<template>
  <div
    class="pt-2 pb-2 px-6 default-inverted-shadow flex flex-col justify-center items-center"
  >
    <div class="flex flex-row justify-center py-1.5">
      <!-- Certification Icon -->
      <svg
        width="24"
        height="24"
    ...
    <PoweredBySVG />
    <!-- CopyRight -->
    <span class="copy-right-text mt-2">© 2016-2020 KoreConX Inc.</span>
  </div>
</template>

<script>
import PoweredBySVG from './svg/PoweredBySVG.vue';
export default {
  name: 'SideNavBarFooter',
  components: {
    PoweredBySVG,
  },
};
